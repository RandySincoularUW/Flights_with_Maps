...
/*
var whitelist = ['http://44.203.47.138:8000']
*/
...
app.use(function (req, res, next) {
  ...
  // res.setHeader('Access-Control-Allow-Origin', 'http://52.55.166.136:8000/hello');
  // 1-Jan-23
  res.setHeader('Access-Control-Allow-Origin', 'http://52.55.166.136');
...
// 31-Dec-22 comment out for testing
// app.options('*',cors())
